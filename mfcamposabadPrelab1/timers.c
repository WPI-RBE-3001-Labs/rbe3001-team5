 ...
 *      Author: MLamare edited by Matias and Kushagra
 */
...
void initTimer(int timer, int mode, unsigned int comp){
	if(timer == 0){
		...
		//Sets timer 0 to Normal Port Operation
		//TCCR0A &= 0b00001100 ;
		//Clear overflow flag
		//TIFR0 |= 0b00000001;
...
/* Uncomment if initializing other timers needed.
 * Must be setup not working.
